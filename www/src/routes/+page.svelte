<script>
    ...
    import audiBack from "$lib/images/audi_back.jpeg"
</script>
...
<div style="background-color: white;z-index: 100;position:relative;">
    <div style="background-color: white; 100;color:black;position:relative;" class="container">
